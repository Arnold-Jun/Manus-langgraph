...
public class LLM {
     ...
     * @return 异步返回LLM的响应内容
     */
    public CompletableFuture<String> call(List<com.zhouruojun.manus.domain.model.Message> messages) {
     ...
     */
    private List<Message> convertToAiMessages(List<com.zhouruojun.manus.domain.model.Message> messages) {
        List<Message> aiMessages = new ArrayList<>();
        for (com.zhouruojun.manus.domain.model.Message msg : messages) {
     ...
     * @return Spring AI消息
     */
    private Message convertToAiMessage(com.zhouruojun.manus.domain.model.Message message) {
